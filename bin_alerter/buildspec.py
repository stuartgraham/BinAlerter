    ...
    "phases": {
        ...
        "build": {
            "commands": [
                ...
                "aws ssm put-parameter --name \"/BinAlerterWorcester/LatestImage\" --type \"String\" --value $LATEST_IMAGE_TAG --overwrite",
                "echo $TAG_NAME",
                "docker build --no-cache -f Dockerfile_worcester -t $REPO_NAME:$TAG_NAME .",
